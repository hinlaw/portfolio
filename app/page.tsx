            ...
            <div className="col-span-1">
              <div className="sticky top-24">
                ...
                <div className="flex items-center space-x-4 mb-4">
                  <div className="text-xl font-bold text-gray-900 transition-all duration-700 ease-in-out">
              ...
              <div className="space-y-12">
                ...
                >
                  <div className="flex items-start space-x-4 mb-6">
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 mb-3">Reduce Support Costs by 60%</h3>
                ...
                >
                  <div className="flex items-start space-x-4 mb-6">
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 mb-3">Scale Without Hiring</h3>
                      <p className="text-gray-600 leading-relaxed mb-4">
                ...
                >
                  <div className="flex items-start space-x-4 mb-6">
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 mb-3">Improve Customer Experience</h3>
                      <p className="text-gray-600 leading-relaxed mb-4">
